...
if __name__ == '__main__':
    Realizacoes = 20
    Total = 0
    list_of_agents = [AgentAStar(), AgentBestGreedySearch(), AgentBreathFirstSearch(), AgentDepthFirstSearch(), AgentDepthFirstSearchExplored(), AgentIterativeDeepingSearch(), AgentUnifordCostSearch(), AgentBirectionalSearch()]
    names_of_agents = ['A estrela', 'Melhor busca', 'largura', 'profundiade', 'profundiade com lista de visitados',
                       'profundidade iterativa', 'custo uniforme', 'bidirecional']
    ...
    for Agent in list_of_agents:
        ...
        for i in range(Realizacoes):
            print "---------------------------------------------------"
            now = time.time()
            environment = EightPuzzleProblem(50)
